#ifndef UNOS_FACTORY_FACTORY_HH
#define UNOS_FACTORY_FACTORY_HH
...
#define REGISTER_UNOS_VAR(Base, Derived) reg_unos_##Base##_##Derived##_
#define REGISTER_UNOS(Base, Derived, Key, ...)                                \
  static Factory<Base>::register_t<Derived> REGISTER_UNOS_VAR(Base, Derived)( \
      Key, ##__VA_ARGS__);

}  // namespace unos

#endif  // UNOS_FACTORY _FACTORY_HH
